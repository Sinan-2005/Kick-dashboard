...
function SheetTrigger({ asChild, ...props }: SheetPrimitive.Trigger.Props & { asChild?: boolean }) {
  if (asChild) {
    return <SheetPrimitive.Trigger data-slot="sheet-trigger" render={props.children as React.ReactElement} {...props} children={undefined} />
  }
...
function SheetClose({ asChild, ...props }: SheetPrimitive.Close.Props & { asChild?: boolean }) {
  if (asChild) {
    return <SheetPrimitive.Close data-slot="sheet-close" render={props.children as React.ReactElement} {...props} children={undefined} />
  }
